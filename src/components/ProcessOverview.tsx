...
<g opacity="1" style="cursor:pointer" data-step="2"><rect x="493" y="135" width="178" height="52" rx="10" fill="#2EC4B610" stroke="#2EC4B6" stroke-width="2" style="filter:drop-shadow(rgba(46,196,182,0.094) 0px 2px 6px)"/><text x="582" y="161" text-anchor="middle" dominant-baseline="middle" fill="#1A2B3C" font-size="11" font-weight="600" style="pointer-events:none">Виджет на рабочем столе</text></g>
...
<g opacity="1" style="cursor:pointer" data-step="4"><rect x="493" y="275" width="178" height="52" rx="10" fill="#2EC4B610" stroke="#2EC4B6" stroke-width="2" style="filter:drop-shadow(rgba(46,196,182,0.094) 0px 2px 6px)"/><text x="582" y="301" text-anchor="middle" dominant-baseline="middle" fill="#1A2B3C" font-size="11" font-weight="600" style="pointer-events:none">ЕЦП.МИС</text></g>
<g opacity="1" style="cursor:pointer" data-step="5"><rect x="493" y="345" width="178" height="52" rx="10" fill="#2EC4B610" stroke="#2EC4B6" stroke-width="2" style="filter:drop-shadow(rgba(46,196,182,0.094) 0px 2px 6px)"/><text x="582" y="371" text-anchor="middle" dominant-baseline="middle" fill="#1A2B3C" font-size="11" font-weight="600" style="pointer-events:none">Виджет на рабочем столе</text></g>
...
<g data-step="7" style="cursor:pointer"><rect x="703" y="485" width="178" height="52" rx="10" fill="#3A9BD910" stroke="#3A9BD9" stroke-width="2" style="filter:drop-shadow(rgba(58,155,217,0.094) 0px 2px 6px)"/><text x="792" y="511" text-anchor="middle" dominant-baseline="middle" fill="#1A2B3C" font-size="11" font-weight="600" style="pointer-events:none">Виджет на рабочем столе</text></g>
...
<g opacity="1" style="cursor:pointer" data-step="9"><rect x="703" y="625" width="178" height="52" rx="10" fill="#3A9BD910" stroke="#3A9BD9" stroke-width="2" style="filter:drop-shadow(rgba(58,155,217,0.094) 0px 2px 6px)"/><text x="792" y="651" text-anchor="middle" dominant-baseline="middle" fill="#1A2B3C" font-size="11" font-weight="600" style="pointer-events:none">ЕЦП.МИС</text></g>
<g opacity="1" style="cursor:pointer" data-step="10"><rect x="703" y="695" width="178" height="52" rx="10" fill="#3A9BD910" stroke="#3A9BD9" stroke-width="2" style="filter:drop-shadow(rgba(58,155,217,0.094) 0px 2px 6px)"/><text x="792" y="721" text-anchor="middle" dominant-baseline="middle" fill="#1A2B3C" font-size="11" font-weight="600" style="pointer-events:none">Виджет на рабочем столе</text></g>
</svg>`
