...
const IMAGES_TO_PRELOAD = [
  ...
  '/images/widgets/registrar/1.png',
  '/images/widgets/registrar/2.png',
  '/images/widgets/registrar/3.png',
  '/images/widgets/registrar/4.png',
  '/images/widgets/registrar/5.png',
  '/images/widgets/doctor/1.png',
  '/images/widgets/doctor/2.png',
