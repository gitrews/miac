...
<defs><stop offset="100%" stop-color="#E91E8C"/></linearGradient></defs>
...
<g data-step="1" style="cursor:pointer"><rect x="50" y="60" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="95" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">1. Запись в Регистратуру</text></g>
<g data-step="2" style="cursor:pointer"><rect x="50" y="130" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="165" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">2. Вызов пациентов в окно</text></g>
<g data-step="3" style="cursor:pointer"><rect x="50" y="200" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="235" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">3. Уведомление пациента</text></g>
<g data-step="4" style="cursor:pointer"><rect x="50" y="270" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="305" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">4. Оформление услуг</text></g>
<g data-step="5" style="cursor:pointer"><rect x="50" y="340" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="375" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">5. Завершение обслуживания</text></g>
<g></g>
<g data-step="6" style="cursor:pointer"><rect x="50" y="480" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="515" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">6. Вызов пациента в кабинет</text></g>
<g data-step="7" style="cursor:pointer"><rect x="50" y="550" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="585" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">7. Уведомление пациента</text></g>
<g data-step="8" style="cursor:pointer"><rect x="50" y="620" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="655" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">8. Осмотр пациента</text></g>
<g data-step="9" style="cursor:pointer"><rect x="50" y="690" width="200" height="62" rx="6" fill="rgba(46,196,182,0.06)" stroke="rgba(46,196,182,0.15)" stroke-width="1"/><text x="150" y="725" text-anchor="middle" fill="#2D6A4F" font-size="10" font-weight="600">9. Завершение обслуживания</text></g>
